              ...
              {!isMobile &&  <div className='filter1  flex  flex-col'>
                  <div className='flex justify-start  flex-col filter  '>
                    ...
                    <ul className='flex pt-3 flex-col gap-3'>
                      ...
                      {
                        data.map((e, i) => (
                          <li key={i} onClick={() => setCategory(e)} className={`hover:text-orange-600 cursor-pointer ${category === e ? "text-orange-600" : ""} `}>{e}</li>
                        ))
                      }
                    ...
                    <div className='pt-5'>
  <p className='text-xl pb-3 underline underline-offset-4'>Select accessibility tag</p>


  <div className='relative inline-block w-full'>
    <select
      className='block appearance-none w-full bg-black border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline transition duration-300'
    >
      <option value="wheelchair-accessible">Wheelchair Accessible</option>
      <option value="sign-language-support">Sign Language Support</option>
      <option value="braille-materials">Braille Materials Available</option>
      <option value="accessible-parking">Accessible Parking</option>
      <option value="hearing-loops">Hearing Loops</option>
