...
export const About = () => {
  ...
  <div className="grid md:grid-cols-3 gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
    <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
      <p className="text-4xl pb-3 text-center text-yellow-500">About Us</p>
      <p className="text-md">
      At AjiraBora, we are dedicated to empowering persons with disabilities by
              connecting them with meaningful employment opportunities.<br></br><br/>Our mission is
    ...
    <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
      ...
      <ul className="list-disc px-5 text-md">
        <li>
        ...
        <li>
          ...
          We go beyond just customer service. Our team is committed to your growth, 
    ...
    <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
      ...
      <p className="pt-3">
        ...
        with disabilities. Here, you'll connect with like-minded professionals, 
        supportive recruiters, and experienced mentors who are committed to 
