      ...
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white">
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          ...
          <div>
            ...
            <Card
              title="Address"
              content="AjiraBora, Westlands, Nairobi, Kenya"
            />
            <Card
              title="Email"
              content={[
                "General Inquiries: info@ajirabora.co.ke",
                "Support: support@ajirabora.co.ke",
                "Job Applications: jobs@ajirabora.co.ke",
              ]}
            />
            <Card
              title="Phone"
              content={[
                "Customer Support: +254-712-345678",
                "HR & Job Inquiries: +254-712-987654",
              ]}
            />
          ...
          <div>
            ...
            <Accordion
              ...
              answer="Crafting an effective job application is crucial to stand out to potential employers. Make sure to include a tailored resume that highlights your relevant experience and skills. Additionally, write a cover letter that showcases how your qualifications align with the job requirements."
            />
            <Accordion
